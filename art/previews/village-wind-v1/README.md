...
[Карточка и результаты](../../../docs/production/VILLAGE_WIND_01_CHECKS.md). ПК/S23 439/439. Сильный ветер двигает крону медленнее травы/папоротника; опоры остаются неподвижны. Владелец положительно оценил результат после передачи — вид ветра принят по D-076.
