...
В игру подключены только Forest Ground 04 и Grass001: [происхождение и SHA](../../../assets/environment/village-surfaces-v1/sources.json), [рецепт](../../../assets/environment/village-surfaces-v1/README.md). Остальные модели не скачаны/не импортированы, их полигональность, LOD, коллизии и качество экспорта ещё не измерялись. Следующий рекомендуемый ограниченный шаг — несколько бытовых предметов Fantasy Props Standard в существующих дворах.
...
[Официальная страница](https://quaternius.itch.io/fantasy-props-megakit) · **CC0 1.0** · Отобран, не импортирован.

94 бесплатных предмета по листу Standard; весь набор — 211. Готовые проекты движков и потёртые варианты относятся к платным версиям.

**Куда:** Жизнь дворов и комнат. **Оценка:** Первый кандидат для следующего шага. Выбрать телегу, верёвки, мешки, вёдра, столярный инструмент и посуду; приглушить чистые яркие ткани общим материалом. Проверить масштаб, pivot, коллизии и материалы. Набор целиком не тащить в APK.
