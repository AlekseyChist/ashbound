...
20 секунд реального движения на S23. Запись уменьшена до 1280 пикселей по ширине; полный оригинал локально в `.tools/forest-route-checks/`. Это видео для оценки движения, не отдельный замер FPS.
