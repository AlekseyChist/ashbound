...
20 сентября исходная APK и обновлённая сборка установлены на OnePlus 13T; для второго обновления система телефона потребовала подтверждение, владелец его дал. Не отключать защиту установки ради автоматизации. Проверенные хэши и результаты находятся в COURTYARD_CHECKS.md.
