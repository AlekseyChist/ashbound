...
func _ready() -> void:
	...
	DisplayServer.window_set_title("AshBound — Forest Village 0.23.4")
	print("VILLAGE_SETTLEMENT_READY version=0.23.4 houses=3 trees=",dressing.tree_positions.size())
