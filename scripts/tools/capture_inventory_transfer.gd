...
func _run() -> void:
	...
	inv.configure_storage([{"id":"traveler_clothing_pocket", "kind":"pocket", "capacity":6}, {"id":"qa_bag", "kind":"backpack", "capacity":8}])
	...
	check(inv.get_item_storage(bread.instance_id) == "qa_bag", "real touch moves whole stack")
