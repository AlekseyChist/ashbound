...
const name=validation?'combat-ui-validation':'combat-ui-preview';
...
if(!args.includes('--stage-only')){
 ...
 const windows=path.join(root,'.tools/builds/combat-ui-preview/AshBound-Combat-UI.exe');
