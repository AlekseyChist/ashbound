...
Локальной модели поручаем игровую реализацию и исправления, сцены и Blender. Основные тесты по отдельному указанию владельца готовит, пишет/исправляет и запускает Codex самостоятельно; не передавать ключевые проверки мосту Ollama. Обнаруженную игровую ошибку возвращать локальной модели с воспроизведением, сохраняя независимые ожидания теста. Полное распределение ответственности — в [AGENTS.md](../AGENTS.md).
