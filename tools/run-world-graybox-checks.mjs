...
for(const [name,options,userArgs,expected] of [
 ...
 try{execFileSync(godot,['--path',stage,...options,'res://scripts/tools/validate_world_graybox.tscn','--',...userArgs,'--no-mouse-capture','--output',dir],{cwd:root,windowsHide:true,timeout:480000,stdio:['ignore',fd,fd]});}catch(e){error=e;}finally{fs.closeSync(fd);}
