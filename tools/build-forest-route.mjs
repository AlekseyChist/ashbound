...
const motion=args.includes('--side-run'),qa=args.includes('--validate')||motion,name=motion?'side-run-validation':qa?'forest-route-validation':'forest-route-preview';
...
const version='0.19.1-side-run',code=46;
const scene=motion?'scripts/tools/validate_side_run.tscn':qa?'scripts/tools/validate_forest_route.tscn':'scenes/world/forest_route.tscn';
const packageId=motion?'org.ashbound.motionvalidation':qa?'org.ashbound.forestvalidation':'org.ashbound.forestroute';
