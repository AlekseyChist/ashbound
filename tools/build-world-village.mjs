...
const resources=[scene,'scenes/world/world.tscn','scenes/world/village_settlement.tscn','scenes/world/village_walkthrough.tscn','scenes/world/player_rig.tscn','scenes/world/village_pocket_menu.tscn','scripts/world/player_rig.gd','scenes/courtyard/resident.tscn','scenes/courtyard/props/woodpile.tscn','scenes/courtyard/props/dummy.tscn','assets/characters/courtyard/watchman_frames.tres','assets/characters/courtyard/innkeeper_frames.tres','scripts/courtyard/interaction_point.gd','scripts/courtyard/courtyard_resident.gd','assets/buildings/ashbound/courtyard_well.glb','assets/environment/medieval_kit/detail-barrel.glb','assets/environment/medieval_kit/detail-crate.glb','assets/environment/medieval_kit/fence-wood.glb',...files.filter(f=>f.startsWith('scripts/world/village_')||f.startsWith('scripts/world/world')||f.startsWith('assets/environment/village-forest-v1/')||(f.startsWith('assets/environment/village-house-materials-v1/')&&f.endsWith('.jpg'))||(f.startsWith('assets/environment/village-surfaces-v1/')&&f.endsWith('.jpg'))||f.startsWith('assets/shaders/village_')||f.startsWith('assets/buildings/forest-village-v1/')||f.startsWith('assets/characters/world-graybox-v1/')).filter(f=>!f.endsWith('.import')&&!f.endsWith('.uid'))];
