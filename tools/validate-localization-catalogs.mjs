...
const courtyardFixture = ['courtyard_localization.json', 'inventory_localization.json', 'menu_localization.json', 'character_localization.json', 'map_localization.json', 'save_localization.json', 'item_behavior_localization.json'].flatMap(file =>
