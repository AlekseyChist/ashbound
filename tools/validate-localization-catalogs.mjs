...
const courtyardFixture = ['courtyard_localization.json', 'inventory_localization.json', 'menu_localization.json', 'character_localization.json', 'map_localization.json', 'save_localization.json', 'item_behavior_localization.json', 'settings_localization.json', 'fist_localization.json', 'combat_localization.json'].flatMap(file =>
